...
(function () {
  ...
  if (
    ((g = 'https://js.stripe.com'),
    (c = 'https://js.stripe.com'),
    (d = !!/stripe\.com$/.test(
      'undefined' != typeof window && null !== window
        ? window.location.host
        : void 0
    )),
    (b = 'console' in window && 'warn' in window.console),
    !d &&
      'querySelectorAll' in document &&
      b &&
      ((f = document.querySelectorAll('script[src^="' + g + '"]')),
      f.length ||
        console.warn(
  ...
  (this.Stripe = (function () {
    ...
    return (
      ...
      (a._rawRequest = function (b, c) {
        ...
        if ('cors' === this._transport)
          try {
            return this.xhr(b);
          } catch (g) {
            return (
              (d = g),
              a.reportError('XhrThrewError'),
              (this._transport = 'jsonp'),
              this.request(b, !0)
            );
          }
          ...
          (e = (function (c) {
            return function (e, f) {
              ...
              return (
                ...
                (g = new Date().getTime()),
                (h = c._getResourceTiming(null != e ? e.responseURL : void 0)),
                (i = {
                  event: 'rum.stripejs',
                  tokenType: j,
                  url: b.url,
        ...
        if ('string' == typeof b) {
          ...
          if (
            ...
            return (
              ...
              f && a.setLanguage(f),
              null != g.endpoint && (a.endpoint = g.endpoint),
      ...
      return (
        ...
        (a.formatData = function (a, b) {
          ...
          if ((Stripe.utils.underscoreKeys(a), 'string' == typeof a.exp)) {
            try {
              (e = Stripe.utils.parseExpString(a.exp)),
                (a.exp_month = e[0]),
                (a.exp_year = e[1]);
            } catch (f) {
        ...
        (a.create = function (a, b) {
          var c, d;
          return (
            a.key || (a.key = Stripe.key || Stripe.publishableKey),
            Stripe.utils.validateKey(a.key),
            (d = (function () {
              switch (!1) {
                case null == a.card:
                  return 'card';
            ...
            Stripe._language &&
              (c.headers['Accept-Language'] = Stripe._language),
            Stripe.request(c)
          );
        }),
        (a.get = function (a, b) {
    ...
    (this.Stripe.card = (function (a) {
      ...
      return (
        ...
        (b.createToken = function (a, c, d) {
          ...
          return (
            null == c && (c = {}),
            Stripe.token.validate(a, 'card'),
            'function' == typeof c
              ? ((d = c), (c = {}))
              : 'object' != typeof c &&
                ((e = parseInt(c, 10)), (c = {}), e > 0 && (c.amount = e)),
            (c[b.tokenName] = Stripe.token.formatData(a, b.whitelistedAttrs)),
            Stripe.token.create(c, d)
          );
        }),
        ...
        (b.validateCardNumber = function (a) {
          return (
            (a = (a + '').replace(/\s+|-/g, '')),
            a.length >= 10 && a.length <= 16 && b.luhnCheck(a)
          );
        }),
        (b.validateCVC = function (a) {
          return (
            (a = Stripe.utils.trim(a)),
            /^\d+$/.test(a) && a.length >= 3 && a.length <= 4
          );
        }),
    ...
    (this.Stripe.bankAccount = (function (a) {
      ...
      return (
        ...
        (b.createToken = function (a, c, d) {
          return (
            null == c && (c = {}),
            Stripe.token.validate(a, 'bank account'),
    ...
    (this.Stripe.piiData = (function (a) {
      ...
      return (
        k(b, a),
        (b.tokenName = 'pii'),
        (b.whitelistedAttrs = ['personal_id_number']),
        (b.createToken = function (a, c, d) {
          return (
            null == c && (c = {}),
            Stripe.token.validate(a, 'pii data'),
            'function' == typeof c && ((d = c), (c = {})),
            (c[b.tokenName] = Stripe.token.formatData(a, b.whitelistedAttrs)),
            Stripe.token.create(c, d)
          );
    ...
    (this.Stripe.bitcoinReceiver = (function (a) {
      ...
      return (
        k(b, a),
        (b._whitelistedAttrs = ['amount', 'currency', 'email', 'description']),
        (b.createReceiver = function (a, b) {
          var c;
          return (
            Stripe.token.validate(a, 'bitcoin_receiver data'),
            (c = Stripe.token.formatData(a, this._whitelistedAttrs)),
            (c.key = Stripe.key || Stripe.publishableKey),
            Stripe.utils.validateKey(c.key),
            Stripe.request({
        ...
        (b.getReceiver = function (a, b) {
          ...
          return (
            (c = Stripe.key || Stripe.publishableKey),
            Stripe.utils.validateKey(c),
            Stripe.request({
    ...
    (this.Stripe.source = (function (a) {
      ...
      return (
        ...
        (b.get = function (a, b, c) {
          ...
          return (
            (d = Stripe.key || Stripe.publishableKey),
            Stripe.utils.validateKey(d),
            (e = {}),
            (e.key = d),
            (e.client_secret = b),
            Stripe.request({
    ...
    (this.Stripe.threeDSecure = (function () {
      ...
      return (
        (a.create = function (a, b) {
          ...
          return (
            a.key || (a.key = Stripe.key || Stripe.publishableKey),
            a.return_url || (a.return_url = '_callback'),
            Stripe.utils.validateKey(a.key),
            (c = {
        ...
        (a.createIframe = function (a, b, c) {
          var d, e;
          if (((e = null), !Stripe.validator.isUrl(a)))
            throw new Error('redirectUrl must be a valid URL.');
          if (!Stripe.validator.isElementOrId(b))
            throw new Error(
          ...
          return (
            (d = function (a, b) {
              ...
              try {
                ...
                throw (
                  ((d = g),
                  Stripe.reportError('InvalidJSON-3DSecureCallback'),
                  new Error('Stripe.js received invalid JSON'))
                );
              }
    ...
    (this.Stripe.applePay = (function () {
      function a() {}
      return (
        (a.stripeAccount = null),
        (a._isOverHTTPS = function () {
          return 'https:' === window.location.protocol;
        }),
        (a.checkAvailability = function (a) {
          var b, c;
          if (null == a)
            throw new Error(
          ...
          return this._isOverHTTPS()
            ? (
                null != (c = window.ApplePaySession)
                  ? c.canMakePayments()
                  : void 0
              )
              ? ((b = this.stripeAccount
                  ? 'merchant.' +
                ...
                ApplePaySession.canMakePaymentsWithActiveCard(b).then(
                  function (b) {
                    return a(b);
                  }
                ))
        ...
        (a.buildSession = function (a, b, c) {
          return new Stripe.ApplePaySession(a, b, c);
        }),
        (a.createToken = function (a, b) {
          var c, d, e;
          return (
            (c = {
              apple_pay: !0,
              pk_token: Stripe.JSON.stringify(a.token.paymentData),
              pk_token_transaction_id: a.token.transactionIdentifier,
              pk_token_payment_network: a.token.paymentMethod.network,
              pk_token_instrument_name: a.token.paymentMethod.displayName,
            }),
            null != a.billingContact &&
              (c.card = {
                name: [a.billingContact.givenName, a.billingContact.familyName]
                  .join(' ')
                  .trim(),
                address_line1:
                  null != (d = a.billingContact.addressLines) ? d[0] : void 0,
                address_line2:
                  null != (e = a.billingContact.addressLines) ? e[1] : void 0,
                address_city: a.billingContact.locality,
                address_state: a.billingContact.administrativeArea,
                address_zip: a.billingContact.postalCode,
                address_country: a.billingContact.countryCode,
              }),
            Stripe.token.create(c, b)
          );
        }),
        a
      );
  ...
  for (h = 0, i = a.length; h < i; h++)
    (e = a[h]), (this.Stripe[e] = this.Stripe.card[e]);
  (this.Stripe.stripejs_ua = 'stripe.js/6ea8d55'),
  ...
  function () {
    ...
    this.Stripe.isDoubleLoaded ||
      ((a = (function () {
        function a(a, b, d, e) {
          var f, g, h, i, j, k, l, m;
          if (null == window.ApplePaySession && !e)
            throw new Error(
            ...
            g = (function (a) {
              return function (b) {
                ...
                return (
                  ...
                  a.session.abort(),
                  'function' == typeof d ? d(c) : void 0
                );
              };
            })(this),
              this.paymentRequest = c(a),
              i =
                null != (l = this.paymentRequest.shippingMethods)
                  ? l[0]
                  : void 0,
              this.session = e || new ApplePaySession(1, this.paymentRequest),
              h = (function (a) {
                return function (b) {
          ...
          this.addEventListener('shippingmethodselected', function (a) {
            ...
            this.addEventListener(
              ...
              (function (c) {
                return function (e) {
                  var f, g, h, j, k;
                  return null != c._stripeSkipTokenizationForDemo
                    ? void c.session.completePayment(
                        ApplePaySession.STATUS_SUCCESS
                      )
                    : ((j = e.payment),
                      'simulated identifier' ===
                        j.token.transactionIdentifier.toLowerCase() &&
                        ((f = '4242424242424242'),
                        (h = a.currencyCode.toLowerCase()),
                        (g = Stripe.utils.formatAmountWithCurrency(
                          a.total.amount,
                          h
                        )),
                        (k = Math.random().toString(36).slice(-10)),
                        (j.token.transactionIdentifier = [
                          'ApplePayStubs',
                          f,
                          g,
                          h,
                        ...
                        (j.token.paymentData = f)),
                      Stripe.applePay.createToken(j, function (a, e) {
                        var f;
                        return null != e.error
                          ? (c.session.completePayment(
                              ApplePaySession.STATUS_FAILURE
                            ),
                            'function' == typeof d ? d(e.error) : void 0)
                          : ((f = { token: e }),
                            null != i && (f.shippingMethod = i),
                            null != j.shippingContact &&
                              (f.shippingContact = j.shippingContact),
                            b(f, function (a) {
          ...
          return (
            ...
            (d = function (a) {
              ...
              return (
                null == a && (a = 'abort'),
                clearTimeout(e),
                null != (b = i.parentNode) && b.removeChild(i),
                f in window && (window[f] = function () {}),
            ...
            (i.onerror = function () {
              return (
                j.abort(), 'function' == typeof c.error ? c.error(j, c) : void 0
              );
            }),
            (window[f] = function () {
              var a, d;
              ...
              return (
                'function' == typeof c.success &&
                  c.success.apply(c, b.call(a).concat([j])),
                'function' == typeof c.complete
                  ? c.complete('success', j, c)
                  : void 0
              );
            }),
            (h = (c.headers || {})['Accept-Language']),
            c.data || (c.data = {}),
            (c.data.callback = f),
            c.method && (c.data._method = c.method),
            h && (c.data._accept_language = h),
            (i.src = c.url + '?' + Stripe.utils.serialize(c.data)),
        ...
        return (
          ...
          (d = (function (a) {
            return function (b, c) {
              var d, e, g;
              if (
                ((g = b.responseText), (e = void 0), g && g.length && c !== f)
              )
                try {
              ...
              for (; a._errorHandlers.length > 0; )
                a._errorHandlers.shift()(e || b, c);
              return (
                Stripe.reportError(c),
                Stripe._fallBackToOldStripeJsTechniques(),
                Stripe.request(a.o, !0)
              );
            };
          })(this)),
          ...
          (Stripe._socket = new b.Socket({
            ...
            onInternalError: function (a) {
              ...
              (this.onError = function () {}),
                ...
                Stripe._fallBackToOldStripeJsTechniques(),
                (e = Stripe._iframePendingRequests);
              for (b in e)
                d.call(e, b) &&
                  ((c = e[b]),
                  ...
                  : this._socketLoadTime
                    ...
                    : (this.loadTimeout = setTimeout(
                        (function (a) {
                          return function () {
                            return (
                              c('LoadTimeoutError'), (a.onLoad = function () {})
                            );
                          };
                        })(this),
                        this.ackTimeoutDuration
