...
export class ResourceRef<T, P> {
  ...
  readonly error$: BehaviorSubject<string> = new BehaviorSubject('');
  readonly data$: BehaviorSubject<T> = new BehaviorSubject(undefined);
  ...
  public fetch(
    ...
    const options = Object.assign(
      ...
      this.options,
      optionsOverride,
      // force fetchOnly when experiment was off
      !this._experiments.hasVariation('front-5333-persistent-feed', true)
        ? {
            cachePolicy: CachePolicy.fetchOnly,
          }
        : {}
    );
...
export class ApiResource {
  ...
  public query<T, P>(
    ...
    return new QueryRef(this.api, this.storage, this.experimentsService, url, {
      method: ApiRequestMethod.GET,
      ...opts,
    });
  }
