...
describe('NewsfeedComponent', () => {
  ...
  it("should have Top, Subscribed and BoostFeed sections in the toolbar", () => {
    const top = fixture.debugElement.query(By.css('.m-topbar--navigation .m-topbar--navigation--item:nth-child(1) > span'));
    const topTooltip = fixture.debugElement.query(By.css('.m-topbar--navigation .m-topbar--navigation--item:nth-child(1) > m-tooltip'));

    const subscribed = fixture.debugElement.query(By.css('.m-topbar--navigation .m-topbar--navigation--item:nth-child(2) > span'));
    const subscribedTooltip = fixture.debugElement.query(By.css('.m-topbar--navigation .m-topbar--navigation--item:nth-child(2) > m-tooltip'));

    const boostfeed = fixture.debugElement.query(By.css('.m-topbar--navigation .m-topbar--navigation--item:nth-child(3) > span'));
  ...
  it('should have an m-newsfeed--dropdown', () => {
    expect(fixture.debugElement.query(By.css('.m-topbar--navigation m-newsfeed--dropdown'))).not.toBeNull();
  });

  it('should have a User card in the sidebar', () => {
    expect(fixture.debugElement.query(By.css('.m-newsfeed--sidebar minds-card-user'))).not.toBeNull();
  });
  ...
  it('should have a right sidebar', () => {
    ...
    expect(fixture.debugElement.query(By.css('.m-newsfeed--boost-sidebar'))).not.toBeNull();
  });
  ...
  it('should have m-ads-boost in the right sidebar', () => {
    ...
    expect(fixture.debugElement.query(By.css('.m-newsfeed--boost-sidebar m-ads-boost'))).not.toBeNull();
  });
  ...
  it('should have footer with links to different pages and a copyright in the right sidebar', () => {
    ...
    expect(fixture.debugElement.query(By.css('.m-newsfeed--boost-sidebar .m-newsfeed-footer'))).not.toBeNull();

    const ul = fixture.debugElement.query(By.css('.m-newsfeed-footer ul.m-footer-nav')).nativeElement;
