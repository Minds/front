...
export class VirtualScrollerComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    this.wrapGroupDimensions = this.storage.memory.getWrapGroupDimensions();

    if (!this.wrapGroupDimensions) {
  ...
  protected calculateDimensions(): IDimensions {
    ...
    this.storage.memory.setWrapGroupDimensions(this.wrapGroupDimensions);
