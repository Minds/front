...
describe('WalletOverviewComponent', () => {
  ...
  it('should have Wallet', fakeAsync (() => {
    tick();
    expect(fixture.debugElement.query(By.css(`.m-wallet--overview`))).not.toBeNull();

    expect(fixture.debugElement.query(By.css(`.m-wallet--overview-balances`))).not.toBeNull();
