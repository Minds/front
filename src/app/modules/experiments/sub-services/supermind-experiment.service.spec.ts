import { SupermindExperimentService } from './supermind-experiment.service';
...
describe('SupermindExperimentService', () => {
  let service: SupermindExperimentService;

  beforeEach(() => {
    jasmine.clock().uninstall();
    jasmine.clock().install();

    service = new SupermindExperimentService(experimentsServiceMock);
  });
