import { OnchainBoostsExperimentService } from './onchain-boosts-experiment.service';
...
describe('CashBoostsExperimentService', () => {
  let service: OnchainBoostsExperimentService;

  beforeEach(() => {
    jasmine.clock().uninstall();
    jasmine.clock().install();

    service = new OnchainBoostsExperimentService(experimentsServiceMock);
  });
