...
describe('WireV2Service', () => {
  ...
  describe('upgradeCanHaveTrial$', () => {
    ...
    it('should see if upgrade can NOT be trial because we are sending a gift', () => {
      service.upgrades = {
        plus: {
          lifetime: {
            usd: 100,
    ...
    it('should see if upgrade can NOT be trial because we are receiving a gift', () => {
      service.upgrades = {
        plus: {
          lifetime: {
            usd: 100,
      ...
      service.isSendingGift$.next(false);
      service.isReceivingGift$.next(true);
      service.upgradeType$.next('plus');
      service.upgradeInterval$.next('lifetime');
      service.type$.next('usd');
      service.isUpgrade$.next(true);
