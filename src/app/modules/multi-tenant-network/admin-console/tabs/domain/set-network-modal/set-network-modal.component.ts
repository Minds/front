...
@Component({
  selector: 'm-networkAdminConsole__setDomainModal',
  templateUrl: './set-network-modal.component.html',
  styleUrls: ['./set-network-modal.component.ng.scss'],
})
export class NetworkAdminConsoleSetNetworkModalComponent
