...
const DEFAULT_PARAMS: GetAdminAnalyticsChartAndKpisQueryVariables = {
  ...
  fromUnixTs: moment().subtract(30, 'days').unix(),
...
export class NetworkAdminAnalyticsKpisService {
  ...
  private readonly params$: BehaviorSubject<GetAdminAnalyticsChartAndKpisQueryVariables> =
   ...
   */
  public readonly data$: Observable<GetAdminAnalyticsChartAndKpisQuery> =
    this.params$.pipe(
