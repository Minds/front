...
describe('BoostPublisherComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [BoostPublisherComponent],
  ...
  it('should have a sidebar with two items: Earnings and Settings', () => {
    expect(
      fixture.debugElement.query(By.css('.m-page > .m-page--sidebar'))
    ).not.toBeNull();

    const earnings = fixture.debugElement.query(
      By.css(
        '.m-page--sidebar--navigation .m-page--sidebar--navigation--item:first-child'
      )
    );
    ...
    const settings = fixture.debugElement.query(
      By.css(
        '.m-page--sidebar--navigation .m-page--sidebar--navigation--item:last-child'
      )
    );
  ...
  it('should have a router outlet', () => {
    expect(
      fixture.debugElement.query(
        By.css('.m-page > .m-page--main > router-outlet')
      )
    ).not.toBeNull();
  });
});
