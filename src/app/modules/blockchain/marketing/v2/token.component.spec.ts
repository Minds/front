...
describe('BlockchainMarketingTokenV2Component', () => {
  ...
  let fixture: ComponentFixture<BlockchainMarketingTokenV2Component>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        ChangeDetectorRef,
        {
          provide: TokenMarketingService,
          useValue: MockService(TokenMarketingService, {
            has: ['copyData'],
            props: {
              copyData: {
                get: () => {
    ...
    fixture = TestBed.createComponent(BlockchainMarketingTokenV2Component);
