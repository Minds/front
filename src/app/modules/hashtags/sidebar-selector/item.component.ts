...
export class SidebarSelectorItemComponent {
  ...
  @Input() hashtag;
  @Output('hashtagVisibilityChange') hashtagVisibilityChangeEmitter: EventEmitter<any> = new EventEmitter<any>();
  @Output('toggleHashtag') toggleHashtagEmitter: EventEmitter<any> = new EventEmitter<any>();
