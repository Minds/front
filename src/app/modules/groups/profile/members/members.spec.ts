...
describe('GroupsProfileMembers', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [
        ...
        MockComponent({ selector: 'minds-card-user', template: '<ng-content></ng-content>', inputs: ['object'] }),
        MockComponent({ selector: 'minds-groups-card-user-actions-button', template: '', inputs: ['group', 'user'] }),
  ...
  it('should have a minds-groups-profile-members-invite', () => {
    expect(fixture.debugElement.query(By.css('minds-groups-profile-members-invite'))).not.toBeNull();
  });
  ...
  it('should have a list of invitees from minds-groups-profile-members-invite', () => {
    ...
    const img = fixture.debugElement.query(By.css('.m-search-inline-list img:first-child'));
