...
import { requiredFor, optionalFor } from "./validators";

// @todo: Add JP support (add it in country select and form template too)
@Component({
  moduleId: module.id,
  selector: 'minds-wallet-merchants-form-stripe',
  templateUrl: 'stripe.component.html'
})
export class MerchantsFormStripe implements OnInit {
  form: FormGroup;
