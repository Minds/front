...
declare module '~rimraf~glob~minimatch/minimatch' {
...
declare module '~rimraf~glob~minimatch' {
import main = require('~rimraf~glob~minimatch/minimatch');
export = main;
}

// Generated by typings
// Source: https://raw.githubusercontent.com/typed-typings/npm-glob/59ca0f5d4696a8d4da27858035316c1014133fcb/glob.d.ts
declare module '~rimraf~glob/glob' {
import events = require('events');
import fs = require('fs');
import minimatch = require('~rimraf~glob~minimatch');
...
declare module '~rimraf~glob' {
import main = require('~rimraf~glob/glob');
export = main;
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-rimraf/cc98cbd747092eeb0a5c73d211878aacd985e5de/rimraf.d.ts
declare module '~rimraf/rimraf' {
import glob = require('~rimraf~glob');
...
declare module 'rimraf/rimraf' {
import main = require('~rimraf/rimraf');
export = main;
}
